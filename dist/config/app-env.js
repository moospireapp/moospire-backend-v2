...
const cookieOptions = {
    ...
    secure: false,
    sameSite: "lax",
    maxAge: convertToMilliseconds(process.env.TOKEN_LIFE),
};
...
const envConfig = {
    ...
    MORGAN_OUTPUT_FORMAT: process.env.APP_ENV === "development"
    ...
    // NON ENV VARIABLES
    DOMAIN_URL: process.env.APP_ENV === "development"
        ? `http://localhost:${process.env.APP_PORT}`
        : "https://moospire-app",
    COOKIE_OPTIONS: process.env.APP_ENV === "development"
        ? {
            ...cookieOptions,
            domain: "localhost",
        }
